    ...
    <img class="d-block mx-auto mb-4" src="pics\park.png" alt="" width="100px" height="100px">
     ...
     <div class="p-5 mb-4 bg-light rounded-3">
      <div class="container-fluid py-5">
        ...
        <p class="col-md-8 fs-4">You can check your space here!</p>

        <button type="button" class="btn btn-outline-secondary" onclick="location.href='parking_in.jsp'">Enter</button>
      </div>
    </div>
