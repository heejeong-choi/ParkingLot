    ...
    <div class="container col-xl-10 col-xxl-8 px-4 py-5" style="margin-top: 7%;">
      <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
          <h1 class="display-4 fw-bold lh-1 mb-3" style="font-size: 100px;">SEE YOU<br>AGAIN!</h1>
        </div>
        <div class="col-md-10 mx-auto col-lg-5">
          <form class="p-4 p-md-5 border rounded-3 bg-light" method="post">
            <div class="form-floating mb-3">
              <input type="car-number" class="form-control" id="floatingInput" placeholder="" style="width: 70%;"><br>
              <button type="button" class="btn btn-outline-secondary" onclick="location.href='fee.jsp'">Enter</button>
